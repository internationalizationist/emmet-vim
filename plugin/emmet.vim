...
function! s:install_plugin(mode, buffer)
  ...
  \ {'mode': 'i', 'var': 'user_emmet_prev_key', 'key': 'p', 'plug': 'emmet-move-prev', 'func': '<esc>:call emmet#moveNextPrev(1)<cr>'},
  \ {'mode': 'n', 'var': 'user_emmet_prev_key', 'key': 'p', 'plug': 'emmet-move-prev', 'func': ':call emmet#moveNextPrev(1)<cr>'},
